 ...
 * @property \App\Model\Table\FavouriteAlbumsTable&\Cake\ORM\Association\HasMany $FavouriteAlbums
 *
...
class AlbumsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('typology')
            ->maxLength('typology', 20)
            ->requirePresence('typology', 'create')
            ->inList('typology', ['Album', 'Single', 'Ep', 'compile'])
            ->notEmptyString('typology');
